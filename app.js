const products = [
  ...
  {
    id: 4,
    name: "Camera Imou A32",
    price: 450000,
    oldPrice: 550000,
    category: "cam-in",
    badge: "HOT",
    img: "https://images.openai.com/static-rsc-4/hnrWC3CNnEVC_hI7QMb-Cx5jpcSDdEpmfUXs8rQxno91nnUuikMHmVMAabaYNWpLW-JGfPMht2tKr3PoDgP1M5dUKNzkf891IQIXfSEzVLoqygOkGOPTyBrz1MwQi7mKaBbkUHky7cxAeRUJKYJzM4aklPHcz4V6-6TBmznrcytuecRkQlbxZe51NIABozqy ",
    spec: {
      dungLuong: "Full HD",
      tocDo: "AI Detect",
      loai: "Wifi Camera",
  ...
  list.forEach(p => {
    box.innerHTML += `
      <div class="item">
       ...
       <button onclick="addToCart(${p.id})" class="cart-btn">
  🛒 Thêm vào giỏ
</button>
</button>
